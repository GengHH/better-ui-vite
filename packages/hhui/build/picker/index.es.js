...
const [name$d, bem$b, t] = createNamespace("picker");
...
const [name$b, bem$9] = createNamespace("picker-column");
const PICKER_KEY = Symbol(name$b);
...
const [name$a] = createNamespace("picker-toolbar");
...
var Toolbar = defineComponent({
  ...
  setup(props, {
    ...
    const renderTitle = () => {
      ...
      if (props.title) {
        return createVNode("div", {
          "class": [bem$b("title"), "van-ellipsis"]
        }, [props.title]);
      }
    };
    ...
    const renderCancel = () => {
      ...
      return createVNode("button", {
        "type": "button",
        "class": [bem$b("cancel"), HAPTICS_FEEDBACK],
        "onClick": onCancel
    ...
    const renderConfirm = () => {
      ...
      return createVNode("button", {
        "type": "button",
        "class": [bem$b("confirm"), HAPTICS_FEEDBACK],
        "onClick": onConfirm
...
const [name$9, bem$8] = createNamespace("sticky");
const stickyProps = {
  zIndex: numericProp,
...
const [name$8, bem$7] = createNamespace("badge");
const badgeProps = {
  dot: Boolean,
  max: numericProp,
...
const [name$6, bem$5] = createNamespace("swipe");
const swipeProps = {
  loop: truthProp,
  width: numericProp,
  height: numericProp,
...
const [name$5, bem$4] = createNamespace("tabs");
...
const [name$4, bem$3] = createNamespace("tabs");
const tabsProps = {
...
var stdin_default$3 = defineComponent({
  ...
  setup(props, {
    ...
    }) : renderHeader(), createVNode(stdin_default$4, {
      "ref": contentRef,
...
const [name$3, bem$2] = createNamespace("swipe-item");
...
const [name$2, bem$1] = createNamespace("tab");
    ...
    const renderMask = (wrapHeight) => {
      if (hasOptions.value) {
        ...
        return [createVNode("div", {
          ...
          "class": [BORDER_UNSET_TOP_BOTTOM, bem$b("frame")],
          "style": frameStyle
        }, null)];
      }
    };
